...
public class PercentPanel extends JFrame implements ActionListener {
    ...
    public PercentPanel(String title) {
        ...
        setBounds((dimension.width-290)/2, (dimension.height-60)/2, 290, 60);
        setVisible(true);
        setResizable(false);
        setLayout(null);
        ...
        percentBackPanel.setBounds(30, 40, 230, 10);
        ...
        percentFrontPanel.setBounds(30, 40, 0, 10);
    ...
    public void percentShow(double percent){
        ...
        percentFrontPanel.setBounds(30, 40, nowLength, 10);
    }

    public static void main(String[] args) {
        new PercentPanel().percentShow(0.8);
    }
}
